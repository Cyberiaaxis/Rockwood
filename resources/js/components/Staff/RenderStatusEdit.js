...
// console.log("useEffect value", value);
    return (
        ...
        <MaterialUISwitch
            ...
            name="status"
            inputRef={inputRef}
            checked={Boolean((valueState) ? 1 : 0)}
...
export default function renderStatusEdit(params) {
    // console.log("renderStatusEdit", params);
    if (params.rowNode.isAutoGenerated || params.value == null) {
        return "";
    }

    return <StatusEdit {...params} />;
}
